...
export const schema = {
  ...
  description:
    'Get account balance history over time. If accountId is not provided, returns balance history for all accounts. Use get-accounts tool to discover available account IDs.',
